...
| **X bearer / xAI key storage (keyring vs file)** | [docs/SETUP.md](docs/SETUP.md) · [docs/secrets-agent-safety.md](docs/secrets-agent-safety.md) · [docs/tauri-commands.md](docs/tauri-commands.md) **+ src-tauri/src/secrets.rs (STABILITY CONTRACT) + app_dirs.rs** |
