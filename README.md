...
1. Open **X connection**, paste your app Bearer token, **Save credentials** (stored in Rust — not kept in UI state). The panel shows keyring vs file fallback via `get_x_bearer_storage`.
